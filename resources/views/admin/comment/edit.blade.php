        ...
        <form action="{{ route('commentupdate',$comment->id) }}" method="POST">
            ...
            <div class="form-group">
                ...
                <select class="form-control" name="post_id" required>
                    ...
                    <option value="{{$blog->id}}"{{ $comment->post_id == $blog->id ? 'selected' : '' }}>{{$blog->title}}</option>
                    @endforeach
                </select>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" placeholder="Enter Commenter" name="commenter_name" value="{{$comment->commenter_name}}" required>
            </div>
